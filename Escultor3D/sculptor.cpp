          ...
          for(int j = 0; j<ny; j++){
              for(int k = 0; k<nz; k++){
                  if(v[i][j][k].isOn){
                      ...
                      fout << 4 << " " << cont*8+ 0 << " " << cont*8+ 3 << " " << cont*8+ 2 << " " << cont*8+ 1 << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                      fout << 4 << " " << cont*8+ 4 << " " << cont*8+ 5 << " " << cont*8+ 6 << " " << cont*8+ 7 << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                      fout << 4 << " " << cont*8+ 0 << " " << cont*8+ 1 << " " << cont*8+ 5 << " " << cont*8+ 4 << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                      fout << 4 << " " << cont*8+ 0 << " " << cont*8+ 4 << " " << cont*8+ 7 << " " << cont*8+ 3 << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                      fout << 4 << " " << cont*8+ 3 << " " << cont*8+ 7 << " " << cont*8+ 6 << " " << cont*8+ 2 << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                      fout << 4 << " " << cont*8+ 1 << " " << cont*8+ 2 << " " << cont*8+ 6 << " " << cont*8+ 5 << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
